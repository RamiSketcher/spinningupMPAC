...
import spinup.algos.pytorch.mpc_sac.core as core
...
MPC-SAC
    ...
    04. For N epochs:
    05.     For R rollouts
    06.         if R: 0 --> K then (Planning):
    07.             Sample action sequences: at ~ MPC()
    08.             Sample state trajectories w/ (f,at)
    09.             Append data
    10.         else (Optimization):
    11.             Sample action sequences: at ~ pi(at|st)
    12.             Sample state from env w/ at
    13.             Append data
    14.         End
    15.         Optimize SAC w/ D_env_pi
    16.     End
    17.     Update dynamics w/ D_env_f (Pytorch Lightning)
    18. End
"""
...
def mpc_sac(env_fn,
        ...
        num_test_episodes=10, max_ep_len=40, 
    ...
    dyn_model0 = model.dyn_delta0
    dyn_model1 = model.dyn_delta1    
    dyn_model2 = model.dyn_delta2
    dyn_model3 = model.dyn_delta3
    dyn_model4 = model.dyn_delta4
    ...
    var_counts = tuple(core.count_vars(module) for module in [ac.pi, ac.q1, ac.q2, ac, model])
    # logger.log('\nNumber of parameters: \t pi: %d, \t q1: %d, \t q2: %d\n'%var_counts)
    logger.log('\nNumber of parameters: \t pi: %d, \t q1: %d, \t q2: %d, \t v: %d, \t total_ac: %d, \t model: %d\n'%var_counts)
    ...
    dyn_optimizer0 = Adam(model.dyn_delta0.parameters(), lr=lr)
    dyn_optimizer1 = Adam(model.dyn_delta1.parameters(), lr=lr)
    dyn_optimizer2 = Adam(model.dyn_delta2.parameters(), lr=lr)
    dyn_optimizer3 = Adam(model.dyn_delta3.parameters(), lr=lr)
    dyn_optimizer4 = Adam(model.dyn_delta4.parameters(), lr=lr)
