...
class MLPActorCritic(nn.Module):
    ...
    def __init__(self, observation_space, action_space, hidden_sizes_dyn= 500, 
        ...
        self.dyn_delta0 = DynamicsModel(obs_dim, act_dim, hidden_sizes_dyn).to(device)
        self.dyn_delta1 = DynamicsModel(obs_dim, act_dim, hidden_sizes_dyn).to(device)
        self.dyn_delta2 = DynamicsModel(obs_dim, act_dim, hidden_sizes_dyn).to(device)
        self.dyn_delta3 = DynamicsModel(obs_dim, act_dim, hidden_sizes_dyn).to(device)
        self.dyn_delta4 = DynamicsModel(obs_dim, act_dim, hidden_sizes_dyn).to(device)
